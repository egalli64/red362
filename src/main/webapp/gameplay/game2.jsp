...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Pagina 3;
		--web-view-id: Pagina_3;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: Pagina_3;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Mad_rag_io_il_mare_non_lo_regg {
		left: 364px;
		top: 804px;
		position: absolute;
		overflow: visible;
...
<div id="Pagina_3">
	...
	<svg class="Rettangolo_5">
		<rect id="Rettangolo_5" rx="0" ry="0" x="0" y="0" width="1225" height="302">
		</rect>
	</svg>
	<div id="Mad_rag_io_il_mare_non_lo_regg">
		<span>Madò ragà, io il mare non lo reggo proprio,<br/>porco Zeus, prossima volta a Troia<br/>andiamo con il regionale, che da Itaca sono 5 min</span>
	</div>
	<svg class="Rettangolo_7">
		<rect id="Rettangolo_7" rx="0" ry="0" x="0" y="0" width="196" height="64">
		</rect>
	</svg>
	<div onclick="application.goToTargetView(event)" id="Avanti">
		<span><a href="game3.jsp">Avanti</a></span>
	</div>
</div>
</body>
</html>