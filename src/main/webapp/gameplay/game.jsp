...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Pagina 2;
		--web-view-id: Pagina_2;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: Pagina_2;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Ulisse_e_i_suoi_compagni_giung {
		left: 1029px;
		top: 492px;
		position: absolute;
		overflow: visible;
...
<body>
<div id="Pagina_2">
	<img id="Folegandros_2016-09-12_11-25-3" src="/login/images/Folegandros_2016-09-12_11-25-3.png" srcset="/login/images/Folegandros_2016-09-12_11-25-3.png 1x, /login/images/Folegandros_2016-09-12_11-25-3@2x.png 2x">
	<svg class="Rettangolo_3">
		<rect id="Rettangolo_3" rx="0" ry="0" x="0" y="0" width="800" height="157">
		</rect>
	</svg>
	<img id="nave" src="/login/images/nave.png" srcset="/login/images/nave.png 1x, /login/images/nave@2x.png 2x">
	<div id="Lisola_di_Circe">
		<span>L'isola di Circe</span>
	</div>
	<svg class="Rettangolo_4">
		<rect id="Rettangolo_4" rx="0" ry="0" x="0" y="0" width="921" height="347">
		</rect>
	</svg>
	<div id="Ulisse_e_i_suoi_compagni_giung">
		<span>Ulisse e i suoi compagni giungono <br/>su un isola, senza sapere cosa <br/>li attende, sopravvissuti a fatica a <br/>Polifemo, non sanno che l'avrebbero <br/>preso in quel posto ancora pi� forte...</span><br><span style="font-size:60px;">                                                                     </span>
	</div>
	<svg class="Rettangolo_6">
		<rect id="Rettangolo_6" rx="0" ry="0" x="0" y="0" width="188" height="71">
		</rect>
	</svg>
